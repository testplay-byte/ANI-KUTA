...
import { PHASES, PHASE_CHECKLISTS, type Phase } from "@/lib/data";

/**
 * Progress page (v2) — phase list with status, what's done, what's next,
 * blockers. Includes a Checklist component for the current phase.
 */
export default function ProgressPage() {
  const currentPhase =
    PHASES.find((p) => p.status === "blocked" || p.status === "in-progress") ??
    PHASES[1];
