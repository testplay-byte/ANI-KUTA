package com.confused.anikuta.feature.download.components
 ...
 *
 * **Performance design (fixes the scroll-jank issue from the old project):**
 ...
 *
 * D.5: Ported from the old project's `DragReorderableList.kt`.
 *
