...
val detailsModule = module {
    ...
    // DetailsViewModel's 11 constructor params are resolved by Koin:
    ...
    //   (registered in smartMatcherModule + appModule) + ContentResolver +
    //   ContentRepository (registered in contentModule).
