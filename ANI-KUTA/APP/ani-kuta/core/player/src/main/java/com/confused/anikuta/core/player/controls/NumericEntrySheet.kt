 ...
 *
 * Ported from the old project's `NumericEntrySheet.kt`. Self-contained — no
 * project-specific deps (just Material3 + Icons).
 *
...
/**
 * Compact +/- stepper button for the value display row.
 */
@Composable
