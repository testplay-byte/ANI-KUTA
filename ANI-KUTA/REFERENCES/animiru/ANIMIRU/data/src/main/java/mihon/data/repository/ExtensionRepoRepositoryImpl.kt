...
class ExtensionRepoRepositoryImpl(
    ...
    override suspend fun insertRepo(
        ...
        try {
            database.extension_reposQueries.insert(baseUrl, name, shortName, website, signingKeyFingerprint)
    ...
    override suspend fun upsertRepo(
        ...
        try {
            database.extension_reposQueries.upsert(baseUrl, name, shortName, website, signingKeyFingerprint)
        } catch (ex: SQLException) {
            throw SaveExtensionRepoException(ex)
        }
    }
