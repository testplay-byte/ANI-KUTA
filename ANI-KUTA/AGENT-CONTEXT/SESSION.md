...
## 🚧 Open Items / Blocked (refreshed Round 91)
...
- **Version bookkeeping quirk (D-430):** the mainline says 1.1.20/10120 while the shipped debug line is at v1.1.48 — this is CORRECT by doctrine (bumps ride release branches). Don't "fix" it.
